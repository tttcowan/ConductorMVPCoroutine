...
class TwoButtonDialogController(bundle: Bundle) : BaseController<TwoButtonDialogView, TwoButtonDialogPresenter>(bundle), TwoButtonDialogView {
    ...
    companion object {
        ...
        internal fun newInstance(primaryButtonText: String, secondaryButtonText: String, dialogText: String): TwoButtonDialogController {
            val bundle = Bundle()
